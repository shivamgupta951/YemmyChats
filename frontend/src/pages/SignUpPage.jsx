  ...
  return (
    ...
    <>
      <div
        ...
        {/* Signup box */}
        <div className="w-full max-w-md space-y-1 shadow-lg shadow-gray-600 bg-base-300 p-10 rounded-e-3xl transform transition-transform duration-300 ease-in-out hover:scale-105 outline outline-2 outline-gray-600 ">
          {/* Logo section */}
