  ...
  return (
    <div className="h-screen bg-base-200 flex justify-around items-center">
      <div className="flex items-center justify-center space-x-20 w-[70%] h-[90%]">
        ...
        <div className="border w-[30%] text-4xl h-96 mb-40 rounded-badge bg-accent/20 transition-all transform duration-300 ease-in-out hover:scale-105 outline outline-base-300 animate-pulse-slower">
          <div className="m-10 my-5 text-base-content font-bold flex justify-center items-center">
            Yemmy Chats
          </div>
          ...
          <div className="text-lg flex justify-center items-center px-6 my-6 text-warning/70 ">
