...
// Your GLB (already has the card + logo baked in)
import cardGLB from "../assets/card.glb";
// Texture only for the rope/lanyard
...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
  ...
  // Load GLB that already contains your custom card
  const { nodes, materials } = useGLTF(cardGLB);

  // Rope texture
  const ropeTexture = useTexture(lanyardTex);
    ...
    <>
      <group position={[0, 4, 0]}>
        ...
        >
          ...
          >
            {/* Use meshes from your GLB (already textured with your logo) */}
            {nodes.card && (
