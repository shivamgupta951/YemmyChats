...
const AuthImagePattern = ({ title, subtitle }) => {
  return (
    <div className="hidden lg:flex justify-center items-center p-10 bg-[#304146] rounded-lg mr-4 border border-gray-800">
      <div className="text-center">
        ...
        <div className="flex justify-center items-center">
          <div className="text-2xl font-bold mb-4">{title} <span className="text-yellow-700">Yemmy Chats</span></div>
